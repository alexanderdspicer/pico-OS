...
//#define	CVAR_CHANGED		(1U << 4)  //not presently used in any real capacity

#define	CVAR_ROM			(1U << 4)
#define	CVAR_LOCKED			(1U << 5)	// locked temporarily
#define	CVAR_REGISTERED		(1U << 6)	// the var is added to the list of variables

//#define	CVAR_CALLBACK		(1U << 6)	// var has a callback (if func pointer non-null)
