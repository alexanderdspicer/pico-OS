...
Con_DWarning => Con_SafePrintf(true, true, ...)
Con_DPrintf => Con_SafePrintf(true, false, ...)
Con_Warning => Con_SafePrintf(false, true, ...)
Con_SafePrintf => Con_SafePrintf(false, false, ...)
==================
*/
void Con_SafePrintf (bool devel, bool warn, const char *fmt, ...) {
	if(devel && !developer.value)
		return;
